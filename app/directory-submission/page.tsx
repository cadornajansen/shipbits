...
export const metadata = createPageMetadata({
  ...
  description: `Submit once. Get discovered everywhere. ShipBits distributes your product to relevant directories, with transparent submission tracking. Packages from ${formatDirectoryPrice(directoryPlans.starter.priceCentavos)}.`,
  ...
  return (
    <main className="py-12 sm:py-20">
      <SiteContainer className="grid gap-16 sm:gap-24">
        <RevealGroup className="grid items-center gap-10 lg:grid-cols-[1.1fr_1fr] lg:gap-16">
          <RevealItem>
            <div>
              ...
              <p className="mt-6 max-w-xl leading-relaxed text-muted-foreground">
                Launch your product across relevant startup, SaaS, AI,
                developer, and niche directories without filling out the same
                forms over and over.
              </p>
              ...
              <p className="mt-4 text-xs text-muted-foreground">
                From{" "}
                {formatDirectoryPrice(directoryPlans.starter.priceCentavos)} ·
                Human-reviewed submissions · Your product profile, reused
              </p>
            </div>
          </RevealItem>
          <RevealItem>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  ShipBits distributes your product to relevant startup, SaaS,
                  AI, developer, and niche directories. We check fit before
