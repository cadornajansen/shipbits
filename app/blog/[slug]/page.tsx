    ...
    <main className="py-8 sm:py-12">
      ...
      <JsonLd
        data={{
          ...
          author: {
            "@type":
              article.author === "ShipBits editorial team"
                ? "Organization"
                : "Person",
            name: article.author,
          },
        ...
        <div className="mx-auto max-w-3xl">
          <Reveal variant="fade">
            ...
            >
              ...
              >
                <ArrowLeftIcon className="size-4" aria-hidden="true" /> Blog
              </Link>
              <span aria-hidden="true">/</span>
              <span
                aria-current="page"
          ...
          <article>
            <Reveal>
              <header className="flex flex-col items-start gap-4">
                ...
                <h1 className="font-outfit text-3xl leading-tight font-bold tracking-tight sm:text-4xl lg:text-5xl">
                  {article.title}
                </h1>
              ...
              <Reveal variant="scale" className="mt-8">
                <div className="relative aspect-video overflow-hidden rounded-xl border">
                  <Image
                    ...
                    unoptimized={article.cover.startsWith("https://")}
                  />
                </div>
              </Reveal>
            ) : null}
            ...
            <Reveal>
              <aside className="mt-10 flex flex-col items-start gap-3 rounded-xl border p-5 sm:p-6">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Give your product a home in the directory. Listings remain
                  subject to our site policies.
                </p>
                <Button asChild>
        ...
        {relatedArticles.length ? (
          <Reveal>
            ...
            >
              ...
              <h2
                id="related-articles"
                className="mb-6 font-outfit text-2xl font-semibold tracking-tight"
              >
                Keep building
              </h2>
